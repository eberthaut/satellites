...
Vidéo de comment se déplace Planck: http://public.planck.fr/la-mission/couverture-du-ciel
...
! [Caractéristiques techniques de Planck]()
...
! [Image des résultats obtenus de Planck]()

Une précision nettement supérieure:
! [Comparaison Planck et WMAP et CMB]()

## Conclusion

PLANCK est le successeur de MWAP, il permet de vérifier les données que PLANCK avaient mesurées ainsi que de les mettre à jour avec une précision nettement supérieure. De nouveau, ce satellite a permis une avancée colossale dans l'étude de cet énigme qu'est l'univers.
