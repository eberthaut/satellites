...
La Wilkinson Microwave Anisotropy Probe (WMAP) est une mission d'exploration de la NASA lancée en juin 2001 pour réaliser des mesures fondamentales de la cosmologie – l'étude des propriétés de notre Univers. Cette mission a été un succès puisqu'elle a produit notre nouveau modèle de la cosmologie standard. WMAP n’a pas les mêmes objectifs d’observation que le satellite Hipparcos mais a une mission plus ciblée qui permettra de compléter les données recueillies par ce dernier.
...
En effet, à partir d'enregistrements de plus en plus fins de la lumière fossile composant le célèbre Cosmic Microwave Background (rayonnement fossile), les chercheurs peuvent remonter à l’âge, la composition et l’évolution du cosmos observable.
...
![Composition de l'univers](images/wmap_compo.jpg)
...
Mais la carte dressée par COBE a été réalisée consécutivement à des mesures des fluctuations de la température d'une résolution angulaire de seulement 7°-soit 14 fois le diamètre de la Lune-. C'est pourquoi l'envoi d'un nouveau satellite était indispensable.  

MWAP effectue le même type de mesures avec une précision nettement supérieure – la résolution angulaire est d'environ 0,2°- et obtient des résultats beaucoup plus pointus.
...
L'axe du satellite subit une précession qui lui fait décrire un cône de 22,5° autour de la droite reliant le Soleil au satellite. (cf schéma) Le système de contrôle d'attitude comprend deux viseurs d'étoiles et deux capteurs de Soleil, et met en œuvre 3 roues de réaction.

## Mesure du rayonnement

WMAP est constitué par deux télescopes de type grégorien (composé de 2 miroirs, dont un miroir primaire de 1,4 x 1,6 m) qui concentrent le rayonnement micro-ondes sur des radiomètres (refroidis à une température inférieure à 95 Kelvin).
...
* Trouver que l'Univers était composé de 24,0% de matière noire (matière qui n'est pas faite d'atomes).
* Déterminer que l'énergie noire compose 71.4% de l'Univers, causant l'accélération de l'expansion de l'univers.
...
* Mesurer l'amplitude des légères fluctuations dans la densité de l'Univers générées lors de son expansion. Cela constitue une réelle avancée dans la compréhension de l'origine de la structure de l'Univers.
...
COBE et MWAP, tous deux lancés par la NASA ont dressé une première carte du rayonnement fossile et ont ainsi considérablement augmenté notre savoir sur le plus grand des mystères: la création de l'Univers. Mais cela n'est pas encore suffisant pour déceler toute la subtilité de ce mécanisme gigantesque ; c'est pourquoi leur successeur, Planck, sera lancé en 2009 afin de dresser une carte 20 à 30 fois plus précise.
